...
const COLORS = [theme.colors.primary1, theme.colors.secondary1, theme.colors.primary2, theme.colors.secondary2]
const CONFETTI_SIZE_X = Math.random() * 35
const CONFETTI_SIZE_Y = Math.random() * 45
const CONFETTI_SIZE = (CONFETTI_SIZE_X + CONFETTI_SIZE_Y) / 2
...
const styles = StyleSheet.create({
    ...
    confetti: {
        width: CONFETTI_SIZE_X,
        height: CONFETTI_SIZE_Y,
    },
})
